        ...
        <div className="max-w-6xl mx-auto px-6 py-6">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              © {currentYear} {settings?.tenant_name || 'School'}. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
    ...
    <footer className="bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800">
      <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-sm font-semibold text-gray-900 dark:text-white">
                {settings?.tenant_name || 'SchoolApp'}
              </span>
            </div>
        ...
        <div className="py-6 border-t border-gray-100 dark:border-gray-800">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-500 dark:text-gray-400">
              © {currentYear} {settings?.tenant_name || 'SchoolApp'}. All rights reserved.
            </p>
