// components/dashboards/admin/TeacherBulkUpload.tsx
...
import type { UploadRowError, ExportFormat, TemplateFormat } from "@/types/teacherBulkUpload";
  ...
  return (
    <div style={{ maxWidth: 900, margin: "0 auto", padding: "24px 16px", color: "var(--color-text-primary)" }}>
      ...
      <div style={{ marginBottom: 28 }}>
        <h1 style={{ fontSize: 24, fontWeight: 500, margin: 0 }}>Bulk Teacher Upload</h1>
        <p style={{ color: "var(--color-text-secondary)", marginTop: 6, fontSize: 14 }}>
          ...
          All teachers must have unique email addresses and employee IDs.
        </p>
      </div>
      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{ margin: "2px 0 0", fontSize: 12, color: "var(--color-text-secondary)" }}>
            Fill in teacher data exactly as shown. Required columns are marked with *.
          </p>
        </div>
        <div style={{ display: "flex", gap: 8 }}>
          <button onClick={() => teacherBulkUploadService.downloadTemplate("excel")} style={btnOutlineStyle}>
            <IconDownload /> Excel template
          </button>
          <button onClick={() => teacherBulkUploadService.downloadTemplate("csv")} style={btnOutlineStyle}>
                ...
                <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
                  <thead>
                    <tr style={{ background: "var(--color-background-secondary)" }}>
                      {["Row", "Name", "Employee ID", "Staff Type", "Error(s)"].map((h) => (
                  ...
                  <tbody>
                    {result.errors.map((err: UploadRowError, i: number) => (
                      ...
                      >
                        ...
                        <td style={tdStyle}>{err.data?.employee_id ?? "—"}</td>
                        <td style={tdStyle}>{err.data?.staff_type ?? "—"}</td>
