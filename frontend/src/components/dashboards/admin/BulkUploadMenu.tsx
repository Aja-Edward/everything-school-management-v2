 ...
 * BulkUploadMenu.tsx
 *
 * Uses backend-powered template downloads (CSV + Excel)
 */
...
const BulkUploadMenu: React.FC<BulkUploadMenuProps> = ({ onOpenGuide }) => {
  ...
  // ---------------------------------------------------------------------------
  // Handlers (NOW USING BACKEND SERVICE)
  // ---------------------------------------------------------------------------
  ...
  return (
    <div ref={menuRef} className="relative">
      ...
      {/* Dropdown */}
      {open && (
        <div className="absolute right-0 mt-2 w-[280px] bg-white border rounded-2xl shadow-xl z-30">
          ...
          <div className="px-2 pb-2 space-y-1">
            ...
            <MenuItem
              ...
              onClick={() => {
                navigate('/admin/student_bulk_upload');
                setOpen(false);
              }}
            />
          ...
          <div className="px-4 py-2 text-xs text-gray-400 border-t">
            Parents must exist before upload.
          </div>
        </div>
      )}
    </div>
